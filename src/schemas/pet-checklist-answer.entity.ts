...
export class PetChecklistAnswerEntity {
  ...
  static create(
    ...
    if (!petChecklistAnswer.petId || !petChecklistAnswer.petChecklistId) {
      throw new BadRequestException('필수 입력값이 누락되었습니다.');
    }

    return Builder(PetChecklistAnswerEntity)
      .petId(petChecklistAnswer.petId)
      .petChecklistId(petChecklistAnswer.petChecklistId)
      .petChecklistAnswer(petChecklistAnswer.petChecklistAnswer)
      .build();
  }
}
