...
export class FakePetChecklistChoiceRepository implements IPetChecklistChoiceRepository {
    private readonly choices:PetChecklistChoiceEntity[] = [];

    async create(choice: PetChecklistChoice): Promise<PetChecklistChoiceEntity> {
        const newChoice:PetChecklistChoiceEntity = PetChecklistChoiceEntity.create(choice);
